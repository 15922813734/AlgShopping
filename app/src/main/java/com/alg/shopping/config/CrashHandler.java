    ...
    private boolean handleException(Throwable ex) {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                NormalUtils.customShowToast("很抱歉,程序出现异常,即将退出");
                Looper.loop();
            }
        }.start();
//        //收集设备参数信息
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                String path = Constants.DB_DATA_PATH;
            ...
            NormalUtils.customShowToast("很抱歉,程序出现异常,在写入日志时出现异常");
        }
        return null;
    }
}
