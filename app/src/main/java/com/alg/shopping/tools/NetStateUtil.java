...
public class NetStateUtil {
    ...
    public static String getNetWorkTypeName() {
        ConnectivityManager manager = (ConnectivityManager) x.app().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static NetworkInfo getActiveNetworkInfo() {
        return ((ConnectivityManager) x.app().getSystemService(Context.CONNECTIVITY_SERVICE)).getActiveNetworkInfo();
    }
}
